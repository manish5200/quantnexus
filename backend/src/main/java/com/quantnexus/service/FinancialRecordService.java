 ...
 * It handles the heavy lifting: calculating balances, enforcing security rules,
 * and ensuring that nobody can peek at someone else's money.
 * * @author Manish Singh
 */
...
public class FinancialRecordService {
    ...
    public TransactionResponse createTransaction(Long currentUserId, TransactionRequest request){
        ...
        // 1. Math Foundation: Calculate the new 'balanceAfter' snapshot
        ...
        // 2. Build Persistence Model (Reference Number is auto-generated by lifecycle hook)
